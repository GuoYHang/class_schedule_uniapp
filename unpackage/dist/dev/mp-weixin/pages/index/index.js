...
var render = function () {
  ...
  var g0 = _vm.classPickerSelectList.length
  var l0 = _vm.__map(_vm.showWeek, function (w, index) {
    var $orig = _vm.__get_orig(w)
    var g1 = _vm.showDays[index].getMonth()
    var g2 = g1 + 1 == _vm.showMonth ? _vm.showDays[index].getDate() : null
    var g3 = !(g1 + 1 == _vm.showMonth) ? _vm.showDays[index].getDate() : null
    var g4 =
      !(g1 + 1 == _vm.showMonth) && g3 == 1
        ? _vm.showDays[index].getMonth()
        : null
    var g5 =
      !(g1 + 1 == _vm.showMonth) && !(g3 == 1)
        ? _vm.showDays[index].getDate()
        : null
    return {
      $orig: $orig,
      g1: g1,
...
var _date = _interopRequireDefault(__webpack_require__(/*! @/utils/date.js */ 43));
//
//
//
//
...
var _default = {
  ...
  methods: {
    ...
    initClassScheduleData: function initClassScheduleData() {
      this.classTimeList = [['8:40', '9:15'], ['9:25', '10:00'], ['10:30', '11:05'], ['11:15', '11:50'], ['14:00', '14:35'], ['14:45', '15:20'], ['15:50', '16:25'], ['16:35', '17:10'], ['18:30', '19:05'], ['19:15', '19:50'], ['20:00', '20:35'], ['20:45', '21:20']];
      this.classPickerSelectList = ["高一一班(2017级)", "高二一班(2017级)", "高三一班(2017级)"];
      this.termPickerSelectList = {
        "高一一班(2017级)": ["高一(上)", "高一(下)"],
        "高二一班(2017级)": ["高二(上)", "高二(下)"],
        "高三一班(2017级)": ["高三(上)", "高三(下)"]
      };
      this.weekPickerSelectList = {
        "高一一班(2017级)": {
          "高一(上)": ["第1周", "第2周", "第3周"],
          "高一(下)": ["第1周", "第2周", "第3周", "第4周", "第5周"]
        },
        "高二一班(2017级)": {
          "高二(上)": ["第1周", "第2周", "第3周"],
          "高二(下)": ["第1周", "第2周", "第3周", "第4周"]
        },
        "高三一班(2017级)": {
          "高三(上)": ["第1周", "第2周", "第3周"],
          "高三(下)": ["第1周", "第2周", "第3周", "第4周"]
        }
      };
      this.datesDict = {
        "高一一班(2017级)": {
          "高一(上)": {
            "第1周": ["2024-03-04", "2024-03-10"],
            "第2周": ["2024-03-11", "2024-03-17"],
            "第3周": ["2024-03-18", "2024-03-24"]
          },
          "高一(下)": {
            "第1周": ["2024-04-04", "2024-04-10"],
            "第2周": ["2024-04-11", "2024-04-17"],
            "第3周": ["2024-04-18", "2024-04-24"],
            "第4周": ["2024-04-25", "2024-05-01"],
            "第5周": ["2024-05-02", "2024-05-08"]
          }
        },
        "高二一班(2017级)": {
          "高二(上)": {
            "第1周": ["2025-03-04", "2025-03-10"],
            "第2周": ["2025-03-11", "2025-03-17"],
            "第3周": ["2025-03-18", "2025-03-24"]
          },
          "高二(下)": {
            "第1周": ["2025-04-04", "2025-04-10"],
            "第2周": ["2025-04-11", "2025-04-17"],
            "第3周": ["2025-04-18", "2025-04-24"],
            "第4周": ["2025-04-25", "2025-04-31"]
          }
        },
        "高三一班(2017级)": {
          "高三(上)": {
            ...
            "第3周": ["2026-03-18", "2026-03-24"]
          },
          "高三(下)": {
            "第1周": ["2026-04-04", "2026-04-10"],
            "第2周": ["2026-04-11", "2026-04-17"],
            "第3周": ["2026-04-18", "2026-04-24"],
            "第4周": ["2026-04-25", "2026-04-31"]
          }
        }
      };
    ...
    initPickerSelect: function initPickerSelect() {
      ...
      this.showDays = _date.default.genBetweenDates(startDateStr, endDateStr);
      this.showMonth = this.showDays[0].getMonth() + 1;
    },
    classPickerSelect: function classPickerSelect(e) {
    ...
    termPickerSelect: function termPickerSelect(e) {
    ...
    weekPickerSelect: function weekPickerSelect(e) {
      this.weekPickerDefIdx = e.detail.value;
      this.initPickerSelect();
    },
    showLessonInfo: function showLessonInfo(lesson) {
    ...
    adjustLesson: function adjustLesson(showedLessonInfo) {
      // 先验证此老师是否有权限	
      // 获取空闲老师列表
     ...
     */
    changeFreeTeacher: function changeFreeTeacher(e) {
      this.freeTeacherIdx = e.detail.value;
    },
    changeFreeCourse: function changeFreeCourse(e) {
      this.freeCourseIdx = e.detail.value;
    },
    /**
     * 
     */
    confirmLessonAdjust: function confirmLessonAdjust() {
     ...
     */
    setLessonInfoShow: function setLessonInfoShow(mark) {
      this.lessonInfoShow = mark;
    },
    /**
     * @param {Object} mark 'show' or ''
     */
    setLessonAdjustShow: function setLessonAdjustShow(mark) {
      this.lessonAdjustShow = mark;
    },
    getFreeTeacherList: function getFreeTeacherList() {
      var freeTeacherList = ["Apple", "Bananer", "Origin"];
      var freeCourseList = {
        "Apple": ["英语", "数学", "语文"],
        "Bananer": ["计算机", "网络"],
        "Origin": ["物理", "化学"]
